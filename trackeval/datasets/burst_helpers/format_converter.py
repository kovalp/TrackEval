...
class GroundTruthBURSTFormatToTAOFormatConverter:
    ...
    def global_track_id(self, *, local_track_id: Union[str, int], video_id: Union[str, int]) -> int:
...
class PredictionBURSTFormatToTAOFormatConverter:
    ...
    def _visit_seq(self, seq):
        ...
        for frame_segs, img_path in zip(seq['segmentations'], seq['annotated_image_paths']):
